...
export const SEASONS: PblaSeason[] = [
  {
    ...
    teams: [
      ...
      { id: 343514, name: 'Pups LC', gp: 5, wins: 4, losses: 1, ties: 0, otw: 0, otl: 0, pts: 12, pf: 56, pa: 29, diff: 27, streak: 'W4', color: '#ff6600', captain: 'Andrew Sloan', jerseyImg: 'https://img1.wsimg.com/isteam/ip/9e5f3063-7bf9-40d1-b593-5c59c6903080/Pups.png/:/rs=w:600,cg:true,m' },
      { id: 343517, name: 'More Dudes LC', gp: 5, wins: 3, losses: 2, ties: 0, otw: 0, otl: 0, pts: 9, pf: 52, pa: 31, diff: 21, streak: 'L1', color: '#800000', captain: 'Murf Butler', jerseyImg: '/logos/pbla-moredudes.png' },
      ...
      { id: 343512, name: 'Edge', gp: 4, wins: 1, losses: 3, ties: 0, otw: 0, otl: 0, pts: 3, pf: 28, pa: 48, diff: -20, streak: 'L3', color: '#ef4444', captain: 'Matt O\'Brian', jerseyImg: '/logos/pbla-edge.png' },
