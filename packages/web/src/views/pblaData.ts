...
export const SEASONS: PblaSeason[] = [
  {
    ...
    label: '2026 (Current)',
    teams: [
      { id: 343516, name: 'Thunder', gp: 3, wins: 3, losses: 0, ties: 0, otw: 0, otl: 0, pts: 9, pf: 35, pa: 15, diff: 20, streak: 'W3', color: '#facc15', captain: 'Jim Glielmi', jerseyImg: '/logos/pbla-thunder.png' },
      { id: 343514, name: 'Pups LC', gp: 3, wins: 2, losses: 1, ties: 0, otw: 0, otl: 0, pts: 6, pf: 34, pa: 18, diff: 16, streak: 'W2', color: '#ff6600', captain: 'Andrew Sloan', jerseyImg: 'https://img1.wsimg.com/isteam/ip/9e5f3063-7bf9-40d1-b593-5c59c6903080/Pups.png/:/rs=w:600,cg:true,m' },
      { id: 343517, name: 'More Dudes LC', gp: 3, wins: 2, losses: 1, ties: 0, otw: 0, otl: 0, pts: 6, pf: 33, pa: 20, diff: 13, streak: 'W1', color: '#800000', captain: 'Murf Butler', jerseyImg: '/logos/pbla-moredudes.png' },
      { id: 343511, name: 'Outlaws', gp: 3, wins: 2, losses: 1, ties: 0, otw: 0, otl: 0, pts: 6, pf: 30, pa: 23, diff: 7, streak: 'W2', color: '#003087', captain: 'Joe Stainer', jerseyImg: '/logos/pbla-outlaws.png' },
      { id: 343512, name: 'Edge', gp: 2, wins: 1, losses: 1, ties: 0, otw: 0, otl: 0, pts: 3, pf: 13, pa: 22, diff: -9, streak: 'L1', color: '#ef4444', captain: 'Matt O\'Brian', jerseyImg: '/logos/pbla-edge.png' },
      { id: 343515, name: 'Revolution', gp: 4, wins: 0, losses: 4, ties: 0, otw: 0, otl: 0, pts: 0, pf: 19, pa: 58, diff: -39, streak: 'L4', color: '#3b82f6', captain: 'Bill Kennedy', jerseyImg: '/logos/pbla-revolution.png' },
      { id: 343513, name: 'Beer Wolves', gp: 2, wins: 0, losses: 2, ties: 0, otw: 0, otl: 0, pts: 0, pf: 13, pa: 21, diff: -8, streak: 'L2', color: '#22c55e', captain: 'Ryan Mackey', jerseyImg: 'https://img1.wsimg.com/isteam/ip/9e5f3063-7bf9-40d1-b593-5c59c6903080/BeerWolves.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:600,cg:true' },
    ],
    players: [
      { jersey: 55, name: 'Dalton Hofmann', team: 'More Dudes LC', gp: 3, goals: 13, assists: 4, points: 17, penalties: 1, pim: 2 },
      { jersey: 92, name: 'Brian Beatson', team: 'Outlaws', gp: 3, goals: 5, assists: 6, points: 11, penalties: 0, pim: 0 },
      { jersey: 7, name: 'Nick Fox', team: 'Pups LC', gp: 3, goals: 8, assists: 3, points: 11, penalties: 4, pim: 8 },
      { jersey: 10, name: 'Austin Conner', team: 'Thunder', gp: 3, goals: 8, assists: 1, points: 9, penalties: 0, pim: 0 },
      { jersey: 2, name: 'Connor Freer', team: 'Revolution', gp: 4, goals: 4, assists: 3, points: 7, penalties: 1, pim: 2 },
      { jersey: 17, name: 'Murph Butler', team: 'More Dudes LC', gp: 3, goals: 3, assists: 4, points: 7, penalties: 0, pim: 0 },
      { jersey: 96, name: 'George Downey', team: 'Outlaws', gp: 3, goals: 6, assists: 1, points: 7, penalties: 1, pim: 2 },
      { jersey: 4, name: 'Joey Klinges', team: 'Thunder', gp: 3, goals: 3, assists: 4, points: 7, penalties: 1, pim: 2 },
      { jersey: 16, name: 'Dylan Portnoy', team: 'Outlaws', gp: 3, goals: 5, assists: 2, points: 7, penalties: 0, pim: 0 },
      { jersey: 18, name: 'Ryan Rafferty', team: 'Pups LC', gp: 3, goals: 4, assists: 3, points: 7, penalties: 0, pim: 0 },
    ],
    goalies: [
      { jersey: 30, name: 'Sid Johansen', team: 'Revolution', gp: 4, min: 180, ga: 58, gaa: 16.11 },
      { jersey: 4, name: 'Matt Kuhn', team: 'More Dudes LC', gp: 2, min: 90, ga: 14, gaa: 7.78 },
      { jersey: 0, name: 'Bryce Kash', team: 'Outlaws', gp: 3, min: 82, ga: 12, gaa: 7.32 },
      { jersey: 17, name: "Tom O'Hagan", team: 'Edge', gp: 2, min: 75, ga: 20, gaa: 13.33 },
      { jersey: 0, name: 'Toby Feddor', team: 'Beer Wolves', gp: 2, min: 75, ga: 16, gaa: 10.67 },
      { jersey: 30, name: 'Alec Rubman', team: 'Thunder', gp: 2, min: 75, ga: 6, gaa: 4.00 },
      { jersey: 29, name: 'Conor Atkinson', team: 'Thunder', gp: 2, min: 60, ga: 9, gaa: 7.50 },
      { jersey: 69, name: 'Bennett Mileto', team: 'Outlaws', gp: 2, min: 53, ga: 11, gaa: 10.38 },
      { jersey: 28, name: 'Blake Beale', team: 'Pups LC', gp: 2, min: 50, ga: 4, gaa: 4.00 },
      { jersey: 2, name: 'Chase Beale', team: 'Pups LC', gp: 2, min: 45, ga: 8, gaa: 8.89 },
    ],
    rosters: {
      'Beer Wolves': [
