...
export const SEASONS: PblaSeason[] = [
  {
    ...
    teams: [
      ...
      { id: 343511, name: 'Outlaws', gp: 9, wins: 4, losses: 5, ties: 0, otw: 0, otl: 0, pts: 12, pf: 85, pa: 84, diff: 1, streak: 'L3', color: '#003087', captain: 'Joe Stainer', jerseyImg: '/logos/pbla-outlaws.png' },
      { id: 343512, name: 'Edge', gp: 10, wins: 2, losses: 8, ties: 0, otw: 0, otl: 0, pts: 6, pf: 65, pa: 118, diff: -53, streak: 'L3', color: '#ef4444', captain: 'Matt O\'Brian', jerseyImg: '/logos/pbla-edge.png' },
