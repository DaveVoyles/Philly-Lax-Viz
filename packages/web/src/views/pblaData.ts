...
export const SEASONS: PblaSeason[] = [
  {
    ...
    label: '2026 (Current)',
    teams: [
      { id: 343516, name: 'Thunder', gp: 4, wins: 4, losses: 0, ties: 0, otw: 0, otl: 0, pts: 12, pf: 42, pa: 20, diff: 22, streak: 'W4', color: '#facc15', captain: 'Jim Glielmi', jerseyImg: '/logos/pbla-thunder.png' },
      { id: 343514, name: 'Pups LC', gp: 4, wins: 3, losses: 1, ties: 0, otw: 0, otl: 0, pts: 9, pf: 48, pa: 23, diff: 25, streak: 'W3', color: '#ff6600', captain: 'Andrew Sloan', jerseyImg: 'https://img1.wsimg.com/isteam/ip/9e5f3063-7bf9-40d1-b593-5c59c6903080/Pups.png/:/rs=w:600,cg:true,m' },
      ...
      { id: 343511, name: 'Outlaws', gp: 4, wins: 3, losses: 1, ties: 0, otw: 0, otl: 0, pts: 9, pf: 42, pa: 33, diff: 9, streak: 'W3', color: '#003087', captain: 'Joe Stainer', jerseyImg: '/logos/pbla-outlaws.png' },
