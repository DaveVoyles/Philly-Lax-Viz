...
export const SEASONS: PblaSeason[] = [
  {
    ...
    players: [
      ...
      { jersey: 10, name: 'Austin Conner', team: 'Thunder', gp: 10, goals: 24, assists: 6, points: 30, penalties: 2, pim: 7 },
      ...
      { jersey: 33, name: 'Patrick Resch', team: 'Thunder', gp: 11, goals: 16, assists: 7, points: 23, penalties: 3, pim: 6 },
      ...
      { jersey: 76, name: 'Nate Winters', team: 'Beer Wolves', gp: 9, goals: 16, assists: 2, points: 18, penalties: 1, pim: 2 },
      { jersey: 51, name: 'Kyle Marr', team: 'Thunder', gp: 6, goals: 10, assists: 8, points: 18, penalties: 0, pim: 0 },
      { jersey: 4, name: 'Joey Klinges', team: 'Thunder', gp: 7, goals: 9, assists: 9, points: 18, penalties: 2, pim: 4 },
      ...
      { jersey: 91, name: 'Matt Klinges', team: 'Thunder', gp: 9, goals: 11, assists: 5, points: 16, penalties: 0, pim: 0 },
      ...
      { jersey: 99, name: 'Adam Goldner', team: 'Thunder', gp: 8, goals: 10, assists: 4, points: 14, penalties: 2, pim: 4 },
      ...
      { jersey: 21, name: 'Ryan Mackey', team: 'Beer Wolves', gp: 7, goals: 6, assists: 4, points: 10, penalties: 2, pim: 4 },
      ...
      { jersey: 16, name: 'Chris Lasprogata', team: 'Beer Wolves', gp: 5, goals: 5, assists: 2, points: 7, penalties: 3, pim: 6 },
    ...
    goalies: [
      ...
      { jersey: 30, name: 'Alec Rubman', team: 'Thunder', gp: 8, min: 247, ga: 35, gaa: 7.08 },
      ...
      { jersey: 99, name: 'Joshua Hammer', team: 'Beer Wolves', gp: 7, min: 221, ga: 61, gaa: 13.80 },
    ],
    rosters: {
      'Beer Wolves': [
